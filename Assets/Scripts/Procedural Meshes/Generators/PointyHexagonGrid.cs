...
namespace ProceduralMeshes.Generators
{
    ...
    {
        public Bounds Bounds => new Bounds(Vector3.zero, new Vector3((Resolution > 1 ? 0.5f + 0.25f / Resolution : 0.5f) * sqrt(3f),
            0f,
        ...
        public void Execute<S>(int _z, S _streams) where S : struct, IMeshStreams
        {
            ...
            {
                float2 center = (float2(2f * h * x, 0.75f * _z) + centerOffset) / Resolution;
